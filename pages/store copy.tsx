...
const Store = () => {
  ...
  }, [isNativeMint, account, contractProps])
  ...
  useEffect(() => {
    ...
    console.log(isNativeMint)
    if (isPaymentTokenAddressSuccess && isNativeMint === false) {
      fetchToken({
    ...
    } else if (isNativeMint === true) {
      setPaymentTokenSymbol('ETH')
    } else if (isPaymentTokenAddressError) {
      console.log(paymentTokenAddressError)
    }
  }, [paymentTokenAddressData, isNativeMint, isPaymentTokenAddressSuccess, isPaymentTokenAddressError])
  ...
  }, [newUniqueTokens, contractProps, isUniqueTokensError])
  ...
  }, [uniqueTokens, contractProps, currentNetwork])
