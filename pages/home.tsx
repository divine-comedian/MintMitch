      ...
      <div className="p-3 px-4">
        ...
        <div className="bg-white/40 dark:bg-black/40 md:max-w-[60%] p-5 rounded-2xl ">
          ...
          <div className="text-lg font-medium space-y-3">
            ...
            <p>
              If you're one of those <code>code</code> guys that likes to see what's under the hood before you get in
              the car then give a look and a like ⭐ to my Github repositories.
            </p>
