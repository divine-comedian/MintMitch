...
IProps) => {
  ...
  return (
    <nav className="flex items-center bg-gradient-to-r from-cyan-500 to-blue-500 dark:from-blue-500 dark:to-cyan-500  justify-between w-full py-2 px-4 navBarBorder">
      {/* Logo */}
      ...
      {/* Progress bar */}
  <div className="w-64 mx-4">Percent completion to goal: <b>{progressBar}%</b>
